                ...
                {kindSegments.length > 0 ? (
                  <div className="mt-3 flex min-w-0 flex-wrap items-center gap-2">
                    {kindSegments.map((segment) => (
                      <div
                        key={segment.key}
                        className="app-running-speed-segment grid h-8 min-w-40 w-max max-w-full grid-cols-[minmax(0,max-content)_auto] items-center gap-2 overflow-visible px-2.5 text-xs"
                      ...
                      >
                        ...
                        <span className="shrink-0 whitespace-nowrap font-semibold tabular-nums text-foreground/82">
                          {segment.value}
                        </span>
                      </div>
                    ))}
