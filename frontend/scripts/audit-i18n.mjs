...
const englishSentenceStyleExplicitPatterns = [
  ...
  /^xiadown\.settings\.(?:proxyDialogHint|aboutText|generalDescription|appearanceDescription|proxyDescription|systemProxyEmpty|proxyTestSucceeded|proxyTestFailed|pets\.builtinHint)$/,
