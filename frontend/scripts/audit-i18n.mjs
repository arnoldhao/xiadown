...
const englishStyleSkipKeys = new Set([
  ...
  "xiadown.spriteStudio.generationGuide.prompts.conversation",
  "xiadown.spriteStudio.generationGuide.prompts.code",
]);
...
const zhAllowedEnglishKeyPatterns = [
  ...
  /^xiadown\.welcome\.readyHint$/,
  /^xiadown\.spriteStudio\.generationGuide\.prompts\./,
];
