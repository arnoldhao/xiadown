...
function releaseBody(version, pulls) {
  ...
  const sections = [
    ...
    "| --- | --- | --- |",
    `| macOS Apple Silicon | [Download](${downloadBase}/xiadown-macos-arm64-${version}.zip) | [Mirror](https://gh-proxy.com/${downloadBase}/xiadown-macos-arm64-${version}.zip) |`,
    `| macOS Intel | [Download](${downloadBase}/xiadown-macos-x64-${version}.zip) | [Mirror](https://gh-proxy.com/${downloadBase}/xiadown-macos-x64-${version}.zip) |`,
